...
export default function Create() {
    ...
    const updateDiagnoses = async (data) => {
            const options = {
                method: "PATCH",
                url: `/diagnoses/${id}`,
                headers: {
  ...
  return (
    <>
        <Card className="w-full max-w-md mt-4">
            <CardHeader>
                <CardTitle>Update Diagnoses</CardTitle>
            </CardHeader>
            <CardContent>
                <form id="edit-diagnoses-form" onSubmit={form.handleSubmit(handleSubmit)}>
