...
export default function Edit() {
    ...
    const [prescriptionDiagnosisId, setPrescriptionDiagnosisId] = useState(null);

    useEffect(() => {
        if(prescriptionDiagnosisId) {
            form.setValue("diagnosis_id", String(prescriptionDiagnosisId) , {
                shouldValidate: true,
                shouldDirty: true,
            });
        }
    }, [diagnoses, prescriptionDiagnosisId]);
    ...
    useEffect(() => {
            const fetchPrescription = async () => {
                ...
                try {
                    ...
                    setPrescriptionDiagnosisId(prescription.diagnosis_id);
                    form.reset({
  ...
  return (
    <>
        <Card className="w-full max-w-md mt-4">
            ...
            <CardContent>
                <form id="edit-prescription-form" onSubmit={form.handleSubmit(handleSubmit)}>
